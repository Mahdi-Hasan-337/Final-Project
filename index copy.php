                    ...
                    <div class="modal-body m-auto d-block mb-2">
                        <form action="loginActionadmin.php" method="post">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="password" class="form-control" name="al_pass" placeholder="Enter password" id="myInput">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body m-auto d-block mb-2">
                        <form action="registerAction.php" method ="post" style="text-transform: uppercase">
                            ...
                            <div class="mb-3">
                                Username :                        
                                <input type="text" class="form-control" name="ar_username">
                            </div>

                            <div class="mb-3">
                                Email :                        
                                <input type="text" class="form-control" name="ar_email">
                            </div>
        ...
        <div class="modal fade" id="userreg" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
            <div class="modal-dialog" style="display: flex; align-items: center; min-height: calc(100% - 1rem);">
                <div class="modal-content">
                    ...
                    <div class="modal-body m-auto d-block mb-2">
                        <form action="registerActionadmin.php" method ="post" style="text-transform: uppercase">
                            <h4 style="text-align:center; margin-bottom:1rem">USER REGISTER</h4>
                            <div class="mb-3">
                                Username :                        
                                <input type="text" class="form-control" name="ur_username">
                            </div>

                            <div class="mb-3">
                                Email :                        
                                <input type="text" class="form-control" name="ur_email">
                            </div>
