        ...
        <!-- <h5 class="logo">Welcome to our website</h5> -->
          <div class="row justify-content-center">
            ...
            <form action="registerAction.php" method="post">
                ...
                <div class="input-group mb-3">
                    <span class="input-group-text"><i class="fa-solid fa-lock"></i></span>
                    <input type="password" class="form-control" name="ur_pass_confirm" placeholder="Re-enter password" id="confirmPasswordInput">
                    <div class="input-group-text">
                ...
                Already have an account? <a href="loguser.php">Login Here</a>
            </form>
